...
const faqs = [
  {
    ...
    answer: "NexaChat uses advanced AI models via OpenRouter. It's a powerful language model that handles coding, analysis, writing, and general questions with high accuracy.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. Your conversations are stored securely in our database with encrypted authentication. We never share your data with third parties.",
  },
  {

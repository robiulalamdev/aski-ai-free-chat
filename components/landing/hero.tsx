      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-zinc-400 sm:text-xl max-w-2xl mx-auto">
            Ask questions, get instant answers, write code, analyze data — all with a powerful AI assistant. No sign-up required.
          </p>
          ...
          <div className="mt-16 grid grid-cols-3 gap-8 max-w-lg mx-auto">
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-xs text-zinc-500">Instant Replies</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-violet-600/10">
                <Shield className="h-5 w-5 text-violet-400" />
              </div>
              <span className="text-xs text-zinc-500">Server-Side API</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-violet-600/10">
                <Zap className="h-5 w-5 text-violet-400" />
              </div>
              <span className="text-xs text-zinc-500">Free to Use</span>
            </div>
          </div>
        </div>
      </div>

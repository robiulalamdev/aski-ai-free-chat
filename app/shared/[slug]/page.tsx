...
export default function SharedChatPage() {
  ...
  if (notFound || !conv) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#f0ebff] via-[#f8f9fc] to-[#e8e0ff] dark:from-[#0f0d18] dark:via-[#14111e] dark:to-[#1a1726] relative overflow-hidden">
